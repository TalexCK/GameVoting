...
/**
 * Represents a party with members, a leader, and voting state. Parties allow players to group
 * together and participate in games collectively.
 */
public class Party {
  private static final int DEFAULT_MAX_MEMBERS = 16;
  ...
  public void addMember(UUID playerId) {
    if (members.contains(playerId) || canInvite()) {
