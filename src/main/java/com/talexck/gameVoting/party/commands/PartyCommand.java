...
/**
 * Command executor for /party commands. Handles all party management operations including creation,
 * invitations, and leadership.
 */
public class PartyCommand implements CommandExecutor {
  ...
  private boolean handleInvite(Player player, String[] args, PartyManager manager) {
    ...
    if (!party.canInvite()) {
      ...
      MessageUtil.sendTranslated(player, "party.party_full", placeholders);
      return true;
    }
  ...
  /**
   * Handle /party forcestart <game-id> - Force start a game (placeholder for future
   * implementation).
   */
