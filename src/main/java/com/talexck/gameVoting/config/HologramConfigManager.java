...
/**
 * Manager for hologram location configuration. Handles saving and loading hologram locations from
 * config.yml.
 */
public class HologramConfigManager {
  ...
  public void saveLocations() {
    ...
    List<String> serializedLocations =
        locations.stream().map(HologramLocation::serialize).collect(Collectors.toList());
