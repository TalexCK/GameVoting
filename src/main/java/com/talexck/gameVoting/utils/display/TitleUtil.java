...
/**
 * Utility class for sending titles to players. Titles appear in the center of the player's screen.
 *
 * <p>Supports: - Main title and subtitle - Custom fade-in, stay, and fade-out timings - Color codes
 * and MiniMessage format - Clear title functionality
 */
public class TitleUtil {
  ...
  public static void sendTitle(
    ...
    Component titleComponent =
        (title != null && !title.isEmpty()) ? ColorUtil.colorize(title) : Component.empty();
  ...
  public static void clearTitle(Player player) {
    ...
    if (isDebugEnabled()) {
      GameVoting.getInstance()
          .getLogger()
          .info(String.format("[DEBUG] Cleared title for %s", player.getName()));
    }
  }
