...
/**
 * Utility class for sending colored messages to players. Automatically applies color code
 * conversion via ColorUtil.
 *
 * <p>Supports: - Single and multiple line messages - Broadcasting to all players - Permission-based
 * broadcasting - Optional debug logging
 */
public class MessageUtil {
  ...
  public static void broadcast(String message) {
    ...
    if (isDebugEnabled()) {
      GameVoting.getInstance()
          .getLogger()
          .info(String.format("[DEBUG] Broadcast message: %s", ColorUtil.stripColors(message)));
    }
  }
  ...
  public static void broadcast(String message, String permission) {
    ...
    if (isDebugEnabled()) {
      GameVoting.getInstance()
          ...
          .info(
              String.format(
                  "[DEBUG] Broadcast message to %d players with permission '%s': %s",
