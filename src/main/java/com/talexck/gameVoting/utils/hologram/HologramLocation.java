...
/**
 * Represents a hologram location that can be saved to and loaded from config. Format: "world:x:y:z"
 */
public class HologramLocation {
  ...
  /**
   * Serialize this location to config format. Format: "world:x:y:z"
   *
  ...
  /**
   * Parse a hologram location from config format. Format: "world:x:y:z"
   *
