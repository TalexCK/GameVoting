...
/**
 * Repository interface for vote history database operations. Implementations exist for PostgreSQL.
 */
public interface VoteHistoryRepository {
  ...
  /**
   * Initialize database tables/collections for vote history. Should be called on plugin startup.
   *
