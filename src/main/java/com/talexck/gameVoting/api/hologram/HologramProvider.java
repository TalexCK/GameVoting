...
/**
 * Interface for hologram providers. Allows abstraction between different hologram implementations.
 *
 * <p>Implementations: - DecentHologramsProvider (when DecentHolograms is available) -
...
public interface HologramProvider {
  ...
  /**
   * Delete all holograms created by this plugin. Used during plugin shutdown or cleanup.
   *
